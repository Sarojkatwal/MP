...
# from CalculateDepth import load_ADA, ret_depth
# from CalculateOF import load_RAFT, ret_of
...
def detect(opt):
    ...
    # modeldepth = load_ADA(depth_model, device)
    # modelof = load_RAFT(of_model, device)
    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        # cv2.imwrite("./b.png",np.array(img))
        # cv2.imwrite("./a.png",np.array(im0s))
        print(frame_idx)
        ...
        #     of1, of1 = ret_of(
        #         frame_idx, storedimage, im0s, modelof, device, source, saveof=True
        #     )
        #     # dep1=ret_depth(frame_idx,[im0s],modeldepth,device)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=str,
        default="./OpticalFlow/archive/raft-sintel.pth",
    )
    parser.add_argument(
        "--depth_model",
        nargs="+",
        type=str,
        default="./AdaBins/models/AdaBins_kitti.pt",
    )
    parser.add_argument(
        "--yolo_model",
        nargs="+",
