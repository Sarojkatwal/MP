...
export default class Home extends Component {
  ...
  showBorder = () => {
    this.myRef1.current.style.display = "block"
    // console.log("show")
  }
              ...
              (!this.state.prcvideo ?
                <div className='border border-dark '>
                  ...
                  <div className='p-5' >
                    ...
                    <video width="320" height="240" onMouseLeave={this.showBorder} controls ref={this.myRef}>
                      <source
                    ...
                    {this.state.boundingBox &&
                      <>
                        <div ref={this.myRef1} onMouseEnter={this.hideBorder} style={{
                          position: "fixed",
